...
namespace WorldChampion.MRL
{
    ...
    public class TurningInsertData : DataObject
    {
        ...
        public string INDEX_TIMES; //20170523 新增: 可切削角數
    }
    //廠商刀具材質與切削材料配置
    ...
    {
        public string CUTTER_ID; //DB的ID
        public string SUPPLIER;
        public string DESIGNATION; //品名
        public string CUTTER_NAME; //廠內統一規格
        public string CUTTER_TYPE; //種類
        public string CUTTER_ERP_NO; //整體式刀具or捨棄式刀桿的ERP
        public string CUTTER_PHOTO; //整體式刀具or捨棄式刀桿的照片檔名
        ...
        //捨棄式刀具的刀片數據
        public string INSERT_SPEC; //刀片規格
        public string INSERT_DESIGNATION; //刀片品名
        public string INSERT_ERP_NO; //刀片ERP
        public string INSERT_PHOTO; //刀片照片檔名
        public string INSERT_GRADE; //刀片材質
        public string INSERT_INDEX_TIME; //20170523新增: 刀片可切削角數
        //用到第二種刀片的話
        public string INSERT2_SPEC;
        public string INSERT2_DESIGNATION;
        public string INSERT2_ERP_NO;
        public string INSERT2_PHOTO;
        public string INSERT2_GRADE;
        public string INSERT2_NUM; //刀片使用數量
        public string INSERT2_INDEX_TIME; //20170523新增: 刀片2可切削角數

    }
    public class MillingGradeMap : DataObject
    {
        ...
        public string H_CLASS;
    }
    public class MillingHolderData : DataObject
    {
        ...
        public string HOLDER_PHOTO;
        public string IS_TYPE;
    }
    public class MillingHolderStep : DataObject
    {
        public string STEP_ID;
        public string HOLDER_ID;
        public string STEP_INDEX;
        public string UPPER_DIAMETER;
        public string LOWER_DIAMETER;
        public string STEP_LENGTH;
        public string STEP_ANGLE;
        public string STEP_RADIUS;
        public string IS_TYPE;
    }
    #endregion
    ...
    public class ToolListMember
    {
        ...
        public string ERP_NO;
        public string CUTTER_QTY;
        public string CUTTER_LIFE;
        public string FLUTE_QTY;
        public string TITLE;
